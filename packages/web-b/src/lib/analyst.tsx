...
interface AnalystContextValue { analystId: string; setAnalystId: (id: string) => void }
...
export function AnalystProvider({ children }: { children: ReactNode }) {
  ...
  const setAnalystId = (id: string) => { persistAnalystId(id); setId(id); void queryClient.invalidateQueries(); };
